...
@section('content')
    ...
    <div class="mt-6 rounded-2xl border bg-amber-50 border-amber-200 p-4 text-amber-900">
        ...
        <div class="text-sm mt-1">
            Las entregas a proveedores representan plata real pagada. El consumo de peluquería representa costo interno de productos usados.
            Si se suman ambos, puede haber doble conteo contable, pero sirve si la clienta quiere verlos como egresos separados.
        </div>
    </div>
